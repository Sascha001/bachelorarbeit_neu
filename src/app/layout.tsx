        ...
        <script dangerouslySetInnerHTML={{
          __html: `
            ...
            function activateScrollbar() {
              console.log('🟢 Smooth fade-in: 20% to 100%');
              
              // Use class-based approach for smooth transitions
              ...
              // Smooth fade-out after 1.2 seconds: 100% to 20%
              scrollTimeout = setTimeout(() => {
                console.log('🔴 Smooth fade-out: 100% to 20%');
